...
<body class="gradient" id="click" onclick="clickBody()">
  <header class="header">
    <nav role="navigation">
      <div id="menuToggle">
        <input type="checkbox" />
            ...
            <div class="spinner spinner--left">
              ...
              <div class="spinner__face" data-bg="#2b2533">
                <div class="content" data-type="carousel-3">
                  ...
                  <div class="content__right">
                    <div class="content__main">
                      <p>User Friendly<br>The interface of this site is very user Friendly and easy to access to
                        anyone
                        and the Feedback section has set open for the reviews about UI and anything user want to tell
                        us
                        about site.</p>
                    </div>
              ...
              <div class="spinner__face" data-bg="#312f2d">
                <div class="content" data-type="carousel-4">
                  ...
                  <div class="content__right">
                    <div class="content__main">
                      <p>Based on responses<br>user responses are the core of this site and the motto of this site is
                        to
              ...
              <div class="spinner__face" data-bg="#312f2d">
                <div class="content" data-type="carousel-5">
                  ...
                  <div class="content__right">
                    <div class="content__main">
                      <p>Connecting the world<br>To connect the world to respond on any application or news so that
                        the
